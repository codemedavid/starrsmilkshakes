...
export default function CategoriesError({
  ...
  useEffect(() => {
    console.error('[admin/categories] Error boundary caught:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="font-nunito text-sm text-stone-500 mb-8">
          An unexpected error occurred while loading categories. Please try again or contact support if the problem persists.
        </p>
