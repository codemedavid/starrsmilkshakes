    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="border-b border-[#E8E3DA] bg-white px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="h-10 w-44 bg-[#E8E3DA] rounded-[10px] animate-pulse" />
        </div>
      </div>
      ...
      <div className="p-6 space-y-4">
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="bg-white rounded-xl border border-[#E8E3DA] p-5 animate-pulse flex items-start gap-4"
          >
            {/* QR thumbnail skeleton */}
            <div className="h-14 w-14 bg-[#E8E3DA] rounded-lg flex-shrink-0" />
            <div className="flex-1 space-y-2">
              ...
              <div className="h-4 w-32 bg-[#E8E3DA]/40 rounded" />
            </div>
          </div>
        ))}
      </div>
